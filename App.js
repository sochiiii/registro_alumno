...
const App = () => {
  ...
  const agregarCliente = () => {
    ...
    const nuevoCliente = { id: contador, nombre: nombre, fechaReserva: fechaReserva, carnet: carnet, materia: materia };
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.clienteNombre}>
              FORMULARIO DE REGISTRO DE ALUMNOS</Text>
            <TextInput
              style={styles.input}
              placeholder="Nombre"
              value={nombre}
            ...
            <TouchableOpacity style={styles.input} onPress={showDatepicker}>
              <Text>Seleccionar Fecha Nacimiento</Text>
          ...
          >
            ...
            <View style={styles.conte}>
              ...
              style={styles.buttonEliminar}
                ...
                <Text style={styles.clienteNombre}>❌</Text>
              </TouchableOpacity>
            </View>
